...
$role=1;
$username_err = $password_err = $confirm_password_err = $College_err="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($_POST["Collage"]==0)
    {
        $College_err="يرجى اختيار الكلية";
    }
    else
     {
        $College_err="";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)&& empty($College_err)){
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <label>الكلية</label>
                <select  name="Collage" class="form-control <?php echo (!empty($College_err)) ? 'is-invalid' : ''; ?>" >
                <?php
